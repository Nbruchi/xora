export const features = [
  {
    ...
    text: "With Xora, tedious tasks are history. Automation and mart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
    button: {
